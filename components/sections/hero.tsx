  ...
  return (
    ...
    >
      ...
      <div className="container relative grid gap-12 py-20 md:py-28 lg:grid-cols-12 lg:py-32">
        {/* Decorative folio number on the left margin */}
        <div
          aria-hidden
        ...
        <div className="relative lg:col-span-7">
          ...
          >
            Full-stack engineer based in Arizona. Founder of{" "}
            <Link
            ...
            . I build platforms where agents and humans ship code together.
          </motion.p>
    ...
    <div className="relative h-full">
      ...
      >
        ...
        <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
          A beautiful macOS filesystem visualizer — Electron + Vite with a
          custom canvas renderer. Shipped via Stripe.
        </p>
      </motion.div>

      {/* Middle card — terminal-style */}
      <motion.div
