...
export const metadata: Metadata = {
  title: "Experience",
  description:
    "A timeline of where I've shipped: Triforce Software (founder), On Q Property Management (lead engineer), and Veritas Technologies.",
};
...
export default function ExperiencePage() {
  return (
    <>
      <PageHero
        eyebrow="/ experience"
        title="Where I've built — and what I've shipped while there."
        description="Three roles, each one operational and hands-on. I write the code, design the schema, write the Terraform, debug the production incident."
      />
        ...
        <div className="container">
          <div className="rounded-3xl border border-border bg-card p-10 text-center md:p-16">
            ...
            <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
              Grab the full résumé or skim the projects — both have the
              detailed receipts.
            </p>
